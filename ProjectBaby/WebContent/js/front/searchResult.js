function ajaxSearch() {
	...
	if (($("input:checkbox[id='woman']").is(":checked") == true)
			&& ($("input:checkbox[id='man']").is(":checked") == false)) {
		gender = "여";
	} else if (($("input:checkbox[id='woman']").is(":checked") == false)
...
function resultList(data){
	...
	return  `<div class="sitter_wrap" onclick="popUp(\'` + data.name + `\', \'` + data.age + `\', \'` + data.wantLocal + `\', \'` + data.wantPay + `\', \'` + data.wantDate + `\');">
    <div class="card_wrap">
    <div class="d1">
       <div class="photo_layout">
          <div class="_3xT8G" style="display: none;">
       ...
       <div class="info_layout">
          ...
          <div class="info_content">
             <div>
                <span class="local">희망지역 : `+existElement(data.wantLocal) + `</span>
             </div>
          </div>

          <div class="info_content info_txt_align">
             <div class="sitter_age">
             		<span class="age">나이: ` +existElement(data.age)+ ` </span>
...
function popUpCreate(name, age, wantLocal, wantPay, wantDate){
	...
	return `<div class="popup_inner">
			<div id="layer1" class="popupBox empBox">
				<div class="layerInner">
					<div>
						<form action="reserve" method="post">
						<input type="hidden" name="id" value="`+ id +`">
						<p>이름 : ` + existElement(name) + `</p>
						<p>나이 : ` + existElement(age) + `</p>
						<p>희망 지역 : ` + existElement(wantLocal) + `</p>
						<p name="wantPay">희망 시급 : ` + existElement(wantPay) + `</p>
						<p>희망 요일 : ` + existElement(wantDate) + `</p>
