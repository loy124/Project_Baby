...
<%--             buyer_email : '<%=email%>',
            ...
            if ( rsp.success ) {
               ...
               /* alert("point 충전을 성공하셨습니다."); */             
                /* location.href='mypage_point.jsp'; */
                location.href="kakao?type=payAfter&money=<%=totalPrice%>&id=<%=babyMemberDTO.getId()%>";
            }
                ...
                //실패시 이동할 페이지
                /* location.href='mypage_point.jsp'; */
                /*alert("point 충전을 실패하셨습니다"); */
                location.href="kakao?type=payAfter";                
